#
#  Be sure to run `pod spec lint XYXFlatSegmentControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  可以设定是否显示被选中按钮的下划线, 并可自定义下划线厚度. 可通过Gap便捷的对SegmentControl布局进行调整. 也可以随心所欲的设置按钮字体大小和按钮颜色(normal和selected状态). 还能指定初始化时被选择的segment.
                   DESC
  ...
  # Or just: s.author    = "Teresa"
  # s.authors            = { "Teresa" => "yxx.umina@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Teresa"
